...
public class AdminBannerController extends BaseController {
    ...
    public String list(Model model, BannerParam param) {
        List<BannerDto> bannerList = bannerService.list(param);
    ...
    public String add(Model model, HttpServletRequest request,
        ...
        if (editMode) {
            ...
            System.out.println(existCourse.toString());
            if (existCourse == null) {
                model.addAttribute("message", "배너정보가 않습니다.");
                return "common/error";
            }
    ...
    public String addSubmit(Model model, HttpServletRequest request,
        ...
        String baseLocalPath = "C:/dev/spring/fastlms3/files/banner";
        String baseUrlPath = "/files/banner";

        String[] fileNames = FileUtils.fileSave(file, baseLocalPath, baseUrlPath);

        parameter.setFilename(fileNames[0]);
        parameter.setUrlFilename(fileNames[1]);
